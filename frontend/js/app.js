...
const Sidebar = {
  NAV: [
    ...
    { icon: '🗂', label: 'Projects',     href: '/frontend/pages/projects.html',   badge: 'Soon' },
    { section: 'AI Tools' },
    { icon: '💬', label: 'AI Chat',      href: '/frontend/pages/chat.html',       badge: 'Beta' },
    { icon: '🎙', label: 'AI Tutor',     href: '/frontend/pages/tutor.html',      badge: 'Beta' },
    { icon: '🎯', label: 'Interview',    href: '/frontend/pages/interview.html',  badge: 'Beta' },
    { section: 'Career' },
